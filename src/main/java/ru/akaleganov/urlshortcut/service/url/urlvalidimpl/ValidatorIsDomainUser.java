...
/**
 * Class ValidatorIsDomainUser проверяет есть ли уданного пользователя домен
 *
...
public class ValidatorIsDomainUser implements ValidUrlService {
    ...
    /**
     * проверяет есть ли уданного пользователя домен если нету у пользователя домена то нету смысла добавлять
     *
     * @param url
     *         {приходит при добавлении урла}
     * @param user
     *         {@link User}
     *
