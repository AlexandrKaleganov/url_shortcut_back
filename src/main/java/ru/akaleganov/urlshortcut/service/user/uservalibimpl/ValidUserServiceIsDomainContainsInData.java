 ...
 * есть  ли пользователь проверим есть ли домен пользователя в бд
 *
...
public class ValidUserServiceIsDomainContainsInData implements ValidUserService {
    ...
    /**
     * есть ли домен пользователя в бд
     * и если есть то идёт проверка на идентичнойть id  если одинаковые то пропускаем
