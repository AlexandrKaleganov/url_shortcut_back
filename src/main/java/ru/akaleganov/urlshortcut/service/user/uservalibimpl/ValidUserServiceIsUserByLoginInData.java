...
/**
 * Class ValidUserServiceIsUserByLogininData есть  ли пользователь в бд
 *
...
public class ValidUserServiceIsUserByLoginInData implements ValidUserService {
    ...
    /**
     * проверяет есть ли пользователь по логину в бд и если есть то проверяет соответствует ли  id  если да значит это
     * просто обновление пользователя, если нет то засетаем ошибку
     *
     * @param userDTO
     *         {@link UserDTO}
     *
